...
my_dict = {'Olga': 1957, 'Egor':1986, 'Saha': 1945}
print('Dict:', my_dict)
print('Existing value: ', my_dict['Olga'])
print('Not existing value:', my_dict.get('Alex', 'Нет такого ключа'))
my_dict['Alex']= 2023
my_dict['Oksana']= 1983
print('Deleted value:', my_dict.pop('Olga'))
print('Modified dictionary:', my_dict)# Работа со словарями
print()

my_set = {1, 1, 3, 4, 1, 2, 4, 5, 'String', False}
print('Set:', my_set)
my_set.add('Salut!')
my_set.add('int')
my_set.discard(1)
